...
type CaptureStats struct {
	...
	SkippedTruncated atomic.Int64 // DLT-only: EEBus-shaped frames dropped mid-payload
}
...
func (s *CaptureStats) Snapshot() StatsSnapshot {
	return StatsSnapshot{
		...
		SkippedTruncated: s.SkippedTruncated.Load(),
	}
}
...
type StatsSnapshot struct {
	...
	SkippedTruncated int64  `json:"skippedTruncated,omitempty"`
